        ...
        {morningPlan.map(plan => {
            ...
            return (
              <div key={plan.id} 
                ...
                className={`glass-panel ghost-border p-5 flex items-center gap-4 relative overflow-hidden cursor-pointer transition-all ${isActive ? 'bg-surface-container-high ring-1 ring-primary/50 shadow-md' : 'bg-surface-container-highest hover:bg-surface-container-high shadow-sm'}`}>
                ...
                <div className="flex-1 pl-2">
                  ...
                  <h4 className="text-on-surface font-semibold text-lg mb-1">{plan.topic}</h4>
