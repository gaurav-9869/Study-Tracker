...
export default function DailyLedger({
    morningPlan, loggedSessions, setLoggedSessions,
      ...
      <div className="glass-panel ghost-border p-6 flex flex-col gap-6 bg-surface-container-low">
        ...
        <div>
          ...
          <textarea 
            ...
            className="w-full bg-surface-container-lowest border border-outline-variant/10 rounded-lg p-4 text-on-surface focus:border-primary/50 focus:ring-0 focus:outline-none transition-colors placeholder:text-on-surface-variant/50 resize-none font-body" 
